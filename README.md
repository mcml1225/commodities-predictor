...
R-squared (Coefficient of Determination): Variance explained by the model

Typical results on test data:

1-month prediction: R-squared ~0.95+

2-month prediction: R-squared ~0.90+

3-month prediction: R-squared ~0.85+
...
Performance metrics - R-squared, MAE, RMSE for each horizon
